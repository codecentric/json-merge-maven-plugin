...
class JsonMergeMojoTest {
    ...
    @Test
    void shouldMergeJsonFilesStartingWithArray() throws Exception {
        File testFile1 = File.createTempFile("test1", ".json");
        File testFile2 = File.createTempFile("test2", ".json");

        FileUtils.writeStringToFile(testFile1, "[{\"a\":1,\"b\":2}]", StandardCharsets.UTF_8);
        FileUtils.writeStringToFile(testFile2, "[{\"c\":3,\"d\":4},{\"e\":5,\"f\":6}]", StandardCharsets.UTF_8);
        ...
        assertEquals("[{\"a\":1,\"b\":2},{\"c\":3,\"d\":4},{\"e\":5,\"f\":6}]", merged);
    }
}
